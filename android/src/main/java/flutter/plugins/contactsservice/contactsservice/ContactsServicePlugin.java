...
public class ContactsServicePlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener {

  private Activity activity;
  private Result pendingResult;
  private static int PICK_CONTACT = 2015;

  ContactsServicePlugin(Activity activity, ContentResolver contentResolver){
  ...
  public static void registerWith(Registrar registrar) {
    ...
    ContactsServicePlugin instance = new ContactsServicePlugin(registrar.activity(), registrar.context().getContentResolver());
  ...
  public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
    Log.d("dddddddddddddccccccc", "in on activity result method");
    ...
    if (resultCode != RESULT_OK) {
      Log.d("dddddddresult code ", "result code is not OK!!!!!!!");
    ...
    Cursor phoneCursor = activity.getContentResolver().query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,
            ...
            null,
            null);
    Cursor emailCursor = activity.getContentResolver().query(ContactsContract.CommonDataKinds.Email.CONTENT_URI,
            null,
            ContactsContract.CommonDataKinds.Phone.CONTACT_ID + " = "
                    + contactId,
            null,
    ...
    String label = (String) ContactsContract.CommonDataKinds.Phone.getTypeLabel(activity.getResources(), phoneType, customLabel);
    String number = phoneCursor.getString(phoneCursor.getColumnIndex(ContactsContract.CommonDataKinds.Phone.NUMBER));
    String fullName = phoneCursor.getString(phoneCursor.getColumnIndex(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME));
    ...
    contact.put("displayName", fullName);
    contact.put("phoneNumber", phoneNumber);
    contact.put("email", email);

    Log.d("ddddddddddd", contact.toString());
